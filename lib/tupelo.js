...
const setOwnershipPayload = (newOwnerKeys) => {
  var payload = transactions.SetOwnershipPayload.create();
...
const setOwnershipTransaction = (newOwnerKeys) => {
  ...
  var txn = transactions.Transaction.create();
...
const setDataPayload = (path, value) => {
  ...
  var payload = transactions.SetDataPayload.create();
...
const establishTokenPayload = (name, maximum) => {
  var policy = transactions.TokenMonetaryPolicy.create();
  policy.setMaximum(maximum);

  var payload = transactions.EstablishTokenPayload.create();
...
const mintTokenPayload = (name, amount) => {
  var payload = transactions.MintTokenPayload.create();
  payload.setName(name);
...
const sendTokenPayload = (sendId, name, amount, destinationChainId) => {
  var payload = transactions.SendTokenPayload.create();
...
const receiveTokenPayload = (sendId, tip, signature, leaves) => {
  var payload = transactions.ReceiveTokenPayload.create();
